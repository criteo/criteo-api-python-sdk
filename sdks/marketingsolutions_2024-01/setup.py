...
```sh
pip install criteo-api-marketingsolutions-sdk==2024.01.0.250129
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2024.01.0.250129`)

...
class ExternalDeleteBalanceCampaign(ModelNormal):
    ...
    def _from_openapi_data(cls, type, id, *args, **kwargs):  # noqa: E501
        """ExternalDeleteBalanceCampaign - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            attributes ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): body that intentionaly has no attributes. [optional]  # noqa: E501
        """

...
```sh
pip install criteo_api_retailmedia_v2021_07
```
(you may need to run `pip` with root permission: `sudo pip install criteo_api_retailmedia_v2021_07`)

...
```sh
pip install criteo-api-retailmedia-sdk==2023.04.0.240618
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2023.04.0.240618`)

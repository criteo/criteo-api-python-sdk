...
```sh
pip install criteo-api-marketingsolutions-sdk==2024.04.0.240808
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2024.04.0.240808`)

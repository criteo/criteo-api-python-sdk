...
------------- | ------------- | -------------
[**add_funds_by_account_and_balance_id**](BalanceApi.md#add_funds_by_account_and_balance_id) | **POST** /2024-10/retail-media/accounts/{account-id}/balances/{balance-id}/add-funds | 
[**change_dates_by_account_and_balance_id**](BalanceApi.md#change_dates_by_account_and_balance_id) | **POST** /2024-10/retail-media/accounts/{account-id}/balances/{balance-id}/change-dates | 
[**create_balance_by_account_id**](BalanceApi.md#create_balance_by_account_id) | **POST** /2024-10/retail-media/accounts/{account-id}/balances | 
[**get_balance_by_account_and_balance_id**](BalanceApi.md#get_balance_by_account_and_balance_id) | **GET** /2024-10/retail-media/accounts/{account-id}/balances/{balance-id} | 
[**get_balance_history**](BalanceApi.md#get_balance_history) | **GET** /2024-10/retail-media/balances/{balanceId}/history | 
[**get_balances_by_account_id**](BalanceApi.md#get_balances_by_account_id) | **GET** /2024-10/retail-media/accounts/{account-id}/balances | 
[**get_campaigns_by_balance_id**](BalanceApi.md#get_campaigns_by_balance_id) | **GET** /2024-10/retail-media/balances/{balance-id}/campaigns | 
[**modify_balance_by_account_and_balance_id**](BalanceApi.md#modify_balance_by_account_and_balance_id) | **PATCH** /2024-10/retail-media/accounts/{account-id}/balances/{balance-id} | 

...
```sh
pip install criteo-api-retailmedia-sdk==2024.10.0.260119
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2024.10.0.260119`)

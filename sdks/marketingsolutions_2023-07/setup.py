...
```sh
pip install criteo-api-marketingsolutions-sdk==2023.07.0.240808
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2023.07.0.240808`)

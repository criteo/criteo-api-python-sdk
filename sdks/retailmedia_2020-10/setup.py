...
```sh
pip install criteo_api_retailmedia_v2020_10
```
(you may need to run `pip` with root permission: `sudo pip install criteo_api_retailmedia_v2020_10`)

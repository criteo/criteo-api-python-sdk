...
```sh
pip install criteo-api-marketingsolutions-sdk==2023.04.0.240515
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2023.04.0.240515`)

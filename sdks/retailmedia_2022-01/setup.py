...
```sh
pip install criteo-api-retailmedia-sdk==2022.01.0.220927
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2022.01.0.220927`)

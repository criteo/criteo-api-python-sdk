...
class ExternalCampaign(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, promoted_brand_ids, budget_spent, budget_remaining, created_at, updated_at, name, *args, **kwargs):  # noqa: E501
        """ExternalCampaign - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, promoted_brand_ids, budget_spent, budget_remaining, created_at, updated_at, name, *args, **kwargs):  # noqa: E501
        """ExternalCampaign - a model defined in OpenAPI

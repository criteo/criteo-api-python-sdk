...
```sh
pip install criteo-api-marketingsolutions-sdk==2025.04.0.251021
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2025.04.0.251021`)

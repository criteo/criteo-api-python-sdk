...
```sh
pip install criteo-api-marketingsolutions-sdk==2025.04.0.250911
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2025.04.0.250911`)

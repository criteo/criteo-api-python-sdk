...
```sh
pip install criteo-api-retailmedia-sdk==2022.10.0.230601
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2022.10.0.230601`)

...
```sh
pip install criteo-api-marketingsolutions-sdk==2021.10.0.220520
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2021.10.0.220520`)

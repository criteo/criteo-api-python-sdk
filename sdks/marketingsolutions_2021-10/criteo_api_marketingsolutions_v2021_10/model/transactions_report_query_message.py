...
class TransactionsReportQueryMessage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, format, start_date, end_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            event_type (str): Apply a filter on Event type .. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, format, start_date, end_date, *args, **kwargs):  # noqa: E501
        """TransactionsReportQueryMessage - a model defined in OpenAPI

...
```sh
pip install criteo-api-retailmedia-sdk==2023.07.0.240731
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2023.07.0.240731`)

...
```sh
pip install criteo-api-marketingsolutions-sdk==2022.10.0.230320
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2022.10.0.230320`)

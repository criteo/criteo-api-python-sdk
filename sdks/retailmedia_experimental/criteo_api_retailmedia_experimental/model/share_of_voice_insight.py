...
def lazy_import():
    ...
    globals()['ShareOfVoiceFilters'] = ShareOfVoiceFilters


class ShareOfVoiceInsight(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'filters': (ShareOfVoiceFilters,),  # noqa: E501
    ...
    def _from_openapi_data(cls, account_id, dimensions, end_date, metrics, start_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aggregation_level (str): Aggregation level of the report. Allowed values: `category`, `keyword`. Defaults to `category`.. [optional] if omitted the server will use the default value of "category"  # noqa: E501
            filters (ShareOfVoiceFilters): [optional]  # noqa: E501

...
class CreateTargetRequestModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, negative, target_type, *args, **kwargs):  # noqa: E501
        """CreateTargetRequestModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, negative, target_type, *args, **kwargs):  # noqa: E501
        """CreateTargetRequestModel - a model defined in OpenAPI

...
class DigitalShelfIntelligenceInsight(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, aggregation_level, end_date, metrics, start_date, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, aggregation_level, end_date, metrics, start_date, *args, **kwargs):  # noqa: E501
        """DigitalShelfIntelligenceInsight - a model defined in OpenAPI

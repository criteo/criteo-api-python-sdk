# criteo_api_retailmedia_experimental.GatewayApi

All URIs are relative to *https://api.criteo.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_current_application**](GatewayApi.md#get_current_application) | **GET** /experimental/retail-media/me | /experimental/retail-media/me
...
from criteo_api_retailmedia_experimental.api import gateway_api
from criteo_api_retailmedia_experimental.model.application_summary_model_response import ApplicationSummaryModelResponse

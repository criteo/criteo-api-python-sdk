...
```sh
pip install criteo-api-marketingsolutions-sdk==2024.10.0.250626
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2024.10.0.250626`)

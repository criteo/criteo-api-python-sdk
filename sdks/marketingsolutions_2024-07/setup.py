...
```sh
pip install criteo-api-marketingsolutions-sdk==2024.07.0.250409
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2024.07.0.250409`)

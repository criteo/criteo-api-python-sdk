...
```sh
pip install criteo-api-retailmedia-sdk==2022.07.0.230411
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2022.07.0.230411`)

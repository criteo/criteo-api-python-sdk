...
```sh
pip install criteo-api-marketingsolutions-sdk==2026.01.0.260223
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2026.01.0.260223`)

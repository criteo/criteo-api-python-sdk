...
class AdLevelReportRequestAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, advertiser_ids, dimensions, end_date, metrics, start_date, *args, **kwargs):  # noqa: E501
        """AdLevelReportRequestAttributes - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            adset_ids ([str], none_type): Optional filter on ad set IDs. Also satisfies the ad-set-scope requirement for the AdGroupName, ProductId, and AdId breakdown dimensions: if any of those are requested, either adsetIds must be non-empty or AdsetId must also be included in dimensions.. [optional]  # noqa: E501
            format (str): Optional file format of the generated report. Only csv and json are currently supported by this endpoint — excel and xml requests are rejected with a 400 error.. [optional] if omitted the server will use the default value of "json"  # noqa: E501
            timezone (str, none_type): Optional timezone used for the report. Timezone Database (Tz) format.. [optional] if omitted the server will use the default value of "UTC"  # noqa: E501
        """

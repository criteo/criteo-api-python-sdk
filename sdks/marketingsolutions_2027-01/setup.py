...
```sh
pip install criteo-api-marketingsolutions-sdk==2027.01.0.260831
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2027.01.0.260831`)

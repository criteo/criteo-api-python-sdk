...
```sh
pip install criteo-api-retailmedia-sdk==2025.04.0.250709
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2025.04.0.250709`)

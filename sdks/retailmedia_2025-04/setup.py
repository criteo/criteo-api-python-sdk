...
```sh
pip install criteo-api-retailmedia-sdk==2025.04.0.260615
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2025.04.0.260615`)

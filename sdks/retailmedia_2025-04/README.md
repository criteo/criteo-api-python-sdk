...
*AudienceApi* | [**add_remove_contact_list_by_audience_segment**](docs/AudienceApi.md#add_remove_contact_list_by_audience_segment) | **POST** /2025-04/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove | 
...
*AudienceApi* | [**clear_contact_list_by_audience_segment**](docs/AudienceApi.md#clear_contact_list_by_audience_segment) | **POST** /2025-04/retail-media/audience-segments/{audience-segment-id}/contact-list/clear | 
...
*BalanceApi* | [**create_balance_by_account_id**](docs/BalanceApi.md#create_balance_by_account_id) | **POST** /2025-04/retail-media/accounts/{account-id}/balances | 
...
*CampaignApi* | [**get_api_external_v1_categories**](docs/CampaignApi.md#get_api_external_v1_categories) | **GET** /2025-04/retail-media/categories | 
...
*CampaignApi* | [**get_catalog_output**](docs/CampaignApi.md#get_catalog_output) | **GET** /2025-04/retail-media/catalogs/{catalogId}/output | 
*CampaignApi* | [**get_catalog_status**](docs/CampaignApi.md#get_catalog_status) | **GET** /2025-04/retail-media/catalogs/{catalogId}/status | 
...
*CampaignApi* | [**post_api_external_v1_account_catalogs_sellers_by_account_id**](docs/CampaignApi.md#post_api_external_v1_account_catalogs_sellers_by_account_id) | **POST** /2025-04/retail-media/accounts/{accountId}/catalogs/sellers | 
...
*CampaignApi* | [**put_audience_targets_by_line_item_id**](docs/CampaignApi.md#put_audience_targets_by_line_item_id) | **PUT** /2025-04/retail-media/preferred-line-items/{line-item-id}/targeting/audiences | 

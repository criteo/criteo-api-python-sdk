    ...
    def __init__(self, api_client=None):
        ...
        self.add_brands_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/account-management/accounts/{accountId}/brands/add',
        ...
        self.create_private_market_demand_brand_account_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/account-management/accounts/{accountId}/create-brand-account',
        ...
        self.create_private_market_demand_seller_account_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/account-management/accounts/{accountId}/create-seller-account',
        ...
        self.get_api_external_v1_account_private_market_child_accounts_by_account_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/account-management/accounts/{accountId}/private-market-child-accounts',
        ...
        self.get_api_v1_external_accounts_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/accounts',
        ...
        self.grant_consent_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/accounts/{accountId}/grant-consent',
        ...
        self.remove_brands_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/account-management/accounts/{accountId}/brands/remove',
        ...
        self.search_sellers_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/accounts/sellers/search',
        ...
        self.update_sellers_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2025-04/retail-media/account-management/accounts/{accountId}/sellers',

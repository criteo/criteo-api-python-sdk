# criteo_api_retailmedia_v2025_01.AudienceApi

All URIs are relative to *https://api.criteo.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_remove_contact_list_by_audience_segment**](AudienceApi.md#add_remove_contact_list_by_audience_segment) | **POST** /2025-01/retail-media/audience-segments/{audience-segment-id}/contact-list/add-remove | 
...
[**clear_contact_list_by_audience_segment**](AudienceApi.md#clear_contact_list_by_audience_segment) | **POST** /2025-01/retail-media/audience-segments/{audience-segment-id}/contact-list/clear | 

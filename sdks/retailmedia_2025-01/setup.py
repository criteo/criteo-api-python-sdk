...
```sh
pip install criteo-api-retailmedia-sdk==2025.01.0.260210
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2025.01.0.260210`)

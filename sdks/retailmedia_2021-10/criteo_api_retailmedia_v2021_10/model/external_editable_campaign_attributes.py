...
class ExternalEditableCampaignAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, click_attribution_window, view_attribution_window, *args, **kwargs):  # noqa: E501
        """ExternalEditableCampaignAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, click_attribution_window, view_attribution_window, *args, **kwargs):  # noqa: E501
        """ExternalEditableCampaignAttributes - a model defined in OpenAPI

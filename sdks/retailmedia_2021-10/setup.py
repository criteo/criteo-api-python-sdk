...
```sh
pip install criteo-api-retailmedia-sdk==2021.10.0.220926
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2021.10.0.220926`)

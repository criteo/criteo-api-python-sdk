...
```sh
pip install criteo-api-marketingsolutions-sdk==2025.07.0.250819
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2025.07.0.250819`)

...
```sh
pip install criteo-api-retailmedia-sdk==2023.10.0.240207
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2023.10.0.240207`)

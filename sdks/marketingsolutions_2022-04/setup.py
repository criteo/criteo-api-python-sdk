...
```sh
pip install criteo-api-marketingsolutions-sdk==2022.04.0.220926
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2022.04.0.220926`)

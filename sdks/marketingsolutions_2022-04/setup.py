...
```sh
pip install criteo_api_marketingsolutions_v2022_04
```
(you may need to run `pip` with root permission: `sudo pip install criteo_api_marketingsolutions_v2022_04`)

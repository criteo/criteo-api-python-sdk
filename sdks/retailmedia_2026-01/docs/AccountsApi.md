...
------------- | ------------- | -------------
[**account_fees_search**](AccountsApi.md#account_fees_search) | **POST** /2026-01/retail-media/accounts/fees/search | /2026-01/retail-media/accounts/fees/search
[**add_brands**](AccountsApi.md#add_brands) | **POST** /2026-01/retail-media/account-management/accounts/{accountId}/brands/add | /2026-01/retail-media/account-management/accounts/{accountId}/brands/add
[**create_private_market_demand_brand_account**](AccountsApi.md#create_private_market_demand_brand_account) | **POST** /2026-01/retail-media/account-management/accounts/{accountId}/create-brand-account | /2026-01/retail-media/account-management/accounts/{accountId}/create-brand-account
[**create_private_market_demand_seller_account**](AccountsApi.md#create_private_market_demand_seller_account) | **POST** /2026-01/retail-media/account-management/accounts/{accountId}/create-seller-account | /2026-01/retail-media/account-management/accounts/{accountId}/create-seller-account
[**get_accounts**](AccountsApi.md#get_accounts) | **GET** /2026-01/retail-media/accounts | /2026-01/retail-media/accounts
[**get_private_market_child_accounts_by_account_id**](AccountsApi.md#get_private_market_child_accounts_by_account_id) | **GET** /2026-01/retail-media/account-management/accounts/{accountId}/private-market-child-accounts | /2026-01/retail-media/account-management/accounts/{accountId}/private-market-child-accounts
[**grant_consent**](AccountsApi.md#grant_consent) | **POST** /2026-01/retail-media/accounts/{accountId}/grant-consent | /2026-01/retail-media/accounts/{accountId}/grant-consent
[**remove_brands**](AccountsApi.md#remove_brands) | **POST** /2026-01/retail-media/account-management/accounts/{accountId}/brands/remove | /2026-01/retail-media/account-management/accounts/{accountId}/brands/remove
[**search_brands**](AccountsApi.md#search_brands) | **POST** /2026-01/retail-media/brands/search | /2026-01/retail-media/brands/search
[**search_sellers**](AccountsApi.md#search_sellers) | **POST** /2026-01/retail-media/accounts/sellers/search | /2026-01/retail-media/accounts/sellers/search
[**update_account_fees**](AccountsApi.md#update_account_fees) | **POST** /2026-01/retail-media/accounts/fees/update | /2026-01/retail-media/accounts/fees/update
[**update_sellers**](AccountsApi.md#update_sellers) | **PUT** /2026-01/retail-media/account-management/accounts/{accountId}/sellers | /2026-01/retail-media/account-management/accounts/{accountId}/sellers

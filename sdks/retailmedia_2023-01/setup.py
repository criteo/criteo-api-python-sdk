...
```sh
pip install criteo-api-retailmedia-sdk==2023.01.0.231113
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2023.01.0.231113`)

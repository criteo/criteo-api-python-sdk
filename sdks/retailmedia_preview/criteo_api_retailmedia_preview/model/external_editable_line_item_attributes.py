...
class ExternalEditableLineItemAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, start_date, target_bid, is_auto_daily_pacing, status, *args, **kwargs):  # noqa: E501
        """ExternalEditableLineItemAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, start_date, target_bid, is_auto_daily_pacing, status, *args, **kwargs):  # noqa: E501
        """ExternalEditableLineItemAttributes - a model defined in OpenAPI

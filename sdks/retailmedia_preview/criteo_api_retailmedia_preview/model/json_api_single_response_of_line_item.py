...
def lazy_import():
    ...
    globals()['JsonApiBodyWithIdOfInt64AndLineItemAndLineItem'] = JsonApiBodyWithIdOfInt64AndLineItemAndLineItem


class JsonApiSingleResponseOfLineItem(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (JsonApiBodyWithIdOfInt64AndLineItemAndLineItem,),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """JsonApiSingleResponseOfLineItem - a model defined in OpenAPI

        Args:
            data (JsonApiBodyWithIdOfInt64AndLineItemAndLineItem):

...
class CreateBalanceV1(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, deposited, end_date, memo, name, spend_type, start_date, *args, **kwargs):  # noqa: E501
        """CreateBalanceV1 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, deposited, end_date, memo, name, spend_type, start_date, *args, **kwargs):  # noqa: E501
        """CreateBalanceV1 - a model defined in OpenAPI

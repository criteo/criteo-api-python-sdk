...
class BalanceResponseV1(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance_type, created_at, deposited, end_date, memo, name, po_number, private_market_billing_type, remaining, spend_type, spent, start_date, status, updated_at, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            po_number (str, none_type): Purchase Order number.
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance_type, created_at, deposited, end_date, memo, name, po_number, private_market_billing_type, remaining, spend_type, spent, start_date, status, updated_at, *args, **kwargs):  # noqa: E501
        """BalanceResponseV1 - a model defined in OpenAPI

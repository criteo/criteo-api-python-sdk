...
class ExternalLineItemAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, target_retailer_id, name, start_date, *args, **kwargs):  # noqa: E501
        """ExternalLineItemAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, target_retailer_id, name, start_date, *args, **kwargs):  # noqa: E501
        """ExternalLineItemAttributes - a model defined in OpenAPI

...
class PageOfInsertionOrderHistoryChangeDataCaptureV2(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([InsertionOrderHistoryChangeDataCaptureV2],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, meta, data, *args, **kwargs):  # noqa: E501
        """PageOfInsertionOrderHistoryChangeDataCaptureV2 - a model defined in OpenAPI

        Args:
            meta (Metadata):
            data ([InsertionOrderHistoryChangeDataCaptureV2]):

...
class SkuSearchRequestPreview(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, query_string, retailer_id, *args, **kwargs):  # noqa: E501
        """SkuSearchRequestPreview - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_string, retailer_id, *args, **kwargs):  # noqa: E501
        """SkuSearchRequestPreview - a model defined in OpenAPI

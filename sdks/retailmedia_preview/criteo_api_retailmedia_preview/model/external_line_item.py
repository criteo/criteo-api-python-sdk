...
class ExternalLineItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, campaign_id, budget_remaining, created_at, updated_at, target_retailer_id, name, start_date, *args, **kwargs):  # noqa: E501
        """ExternalLineItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, campaign_id, budget_remaining, created_at, updated_at, target_retailer_id, name, start_date, *args, **kwargs):  # noqa: E501
        """ExternalLineItem - a model defined in OpenAPI

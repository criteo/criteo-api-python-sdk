...
class CampaignApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_api_v1_external_account_by_account_id_and_balance_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/preview/retail-media/accounts/{accountId}/balances/{balanceId}',
        ...
        self.get_suggested_keywords_endpoint = _Endpoint(
            settings={
                'response_type': (ValueResourceOutcomeOfSuggestedKeywordsResult,),
                'auth': [
                    'oauth',
                    'oauth'
                ],
                'endpoint_path': '/preview/retail-media/line-items/{externalLineItemId}/keywords/recommended',
                'operation_id': 'get_suggested_keywords',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_api_v1_external_account_add_funds_by_account_id_and_balance_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/preview/retail-media/accounts/{accountId}/balances/{balanceId}/add-funds',
        ...
        self.post_api_v1_external_account_change_dates_by_account_id_and_balance_id_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/preview/retail-media/accounts/{accountId}/balances/{balanceId}/change-dates',
    ...
    def get_suggested_keywords(
        ...
        **kwargs
        ...
        """get_suggested_keywords  # noqa: E501

        Retrieves a collection of recommended keywords for a line item  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_suggested_keywords(external_line_item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['external_line_item_id'] = \
            external_line_item_id
        return self.get_suggested_keywords_endpoint.call_with_http_info(**kwargs)

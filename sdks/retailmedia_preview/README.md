...
------------ | ------------- | ------------- | -------------
*AccountsApi* | [**account_fees_search**](docs/AccountsApi.md#account_fees_search) | **POST** /preview/retail-media/accounts/fees/search | 
...
*AccountsApi* | [**update_account_fees**](docs/AccountsApi.md#update_account_fees) | **POST** /preview/retail-media/accounts/fees/update | 
...
*BalanceApi* | [**change_dates_by_account_and_balance_id**](docs/BalanceApi.md#change_dates_by_account_and_balance_id) | **POST** /preview/retail-media/accounts/{account-id}/balances/{balance-id}/change-dates | 
*BalanceApi* | [**create_balance_by_account_id**](docs/BalanceApi.md#create_balance_by_account_id) | **POST** /preview/retail-media/accounts/{account-id}/balances | 
*BalanceApi* | [**get_balance_by_account_and_balance_id**](docs/BalanceApi.md#get_balance_by_account_and_balance_id) | **GET** /preview/retail-media/accounts/{account-id}/balances/{balance-id} | 
...
*BalanceApi* | [**get_balances_by_account_id**](docs/BalanceApi.md#get_balances_by_account_id) | **GET** /preview/retail-media/accounts/{account-id}/balances | 
*BalanceApi* | [**modify_balance_by_account_and_balance_id**](docs/BalanceApi.md#modify_balance_by_account_and_balance_id) | **PATCH** /preview/retail-media/accounts/{account-id}/balances/{balance-id} | 
*BillingApi* | [**create_partner_billing_report_request_v1**](docs/BillingApi.md#create_partner_billing_report_request_v1) | **POST** /preview/retail-media/billing/partner-report | 
*BillingApi* | [**get_partner_billing_report_output_v1**](docs/BillingApi.md#get_partner_billing_report_output_v1) | **GET** /preview/retail-media/billing/partner-report/{requestId}/output | 
*BillingApi* | [**get_partner_billing_report_status_v1**](docs/BillingApi.md#get_partner_billing_report_status_v1) | **GET** /preview/retail-media/billing/partner-report/{requestId}/status | 
...
*CampaignApi* | [**get_api_external_v1_retailer_brands_by_retailer_id**](docs/CampaignApi.md#get_api_external_v1_retailer_brands_by_retailer_id) | **GET** /preview/retail-media/retailers/{retailerId}/brands | 
*CampaignApi* | [**get_api_external_v1_retailer_by_retailer_id_sellersseller**](docs/CampaignApi.md#get_api_external_v1_retailer_by_retailer_id_sellersseller) | **GET** /preview/retail-media/retailers/{retailerId}/sellers/{seller} | 
*CampaignApi* | [**get_api_external_v1_retailer_cpc_rates_by_retailer_id**](docs/CampaignApi.md#get_api_external_v1_retailer_cpc_rates_by_retailer_id) | **GET** /preview/retail-media/retailers/{retailer-id}/cpc-rates | 
*CampaignApi* | [**get_api_external_v1_retailer_placements_by_retailer_id**](docs/CampaignApi.md#get_api_external_v1_retailer_placements_by_retailer_id) | **GET** /preview/retail-media/retailers/{retailer-id}/placements | 
...
*CampaignApi* | [**post_api_external_v1_catalogs_sku_retrieval**](docs/CampaignApi.md#post_api_external_v1_catalogs_sku_retrieval) | **POST** /preview/retail-media/catalogs/sku-retrieval | 
*CampaignApi* | [**post_api_external_v1_catalogs_sku_search**](docs/CampaignApi.md#post_api_external_v1_catalogs_sku_search) | **POST** /preview/retail-media/catalogs/sku-search | 
...
*CampaignApi* | [**search_category**](docs/CampaignApi.md#search_category) | **POST** /preview/retail-media/retailers/{retailerId}/categories/search | 
...
*CatalogApi* | [**offer_load_v1**](docs/CatalogApi.md#offer_load_v1) | **POST** /preview/retail-media/retailers/{retailerId}/offers/load | 
*CatalogApi* | [**offer_set_bbw_v1**](docs/CatalogApi.md#offer_set_bbw_v1) | **POST** /preview/retail-media/retailers/{retailerId}/offers/set-buy-box-winners | 
*CatalogApi* | [**offer_update_v1**](docs/CatalogApi.md#offer_update_v1) | **POST** /preview/retail-media/retailers/{retailerId}/offers/update | 

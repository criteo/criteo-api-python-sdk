...
**type** | **str** | Optional JSON:API resource type. If provided, it must match this create resource. | [optional]  if omitted the server will use the default value of "AsyncAttributedTransactionsReport"

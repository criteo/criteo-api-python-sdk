...
```sh
pip install criteo-api-marketingsolutions-sdk==2023.01.0.240404
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2023.01.0.240404`)

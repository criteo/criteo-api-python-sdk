...
**item_group_id** | **str** | Shared identifier for all variants of the same product. RECOMMENDED. | [optional] 
...
**seller_id** | **str** | The ID of the seller (case sensitive and 50 UTF8 characters max). This information is required by the Criteo Resellers Program. | [optional] 

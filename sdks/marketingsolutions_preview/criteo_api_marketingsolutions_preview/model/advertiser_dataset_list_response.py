...
def lazy_import():
    ...
    globals()['CriteoApiErrorV2'] = CriteoApiErrorV2
...
class AdvertiserDatasetListResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([EntityV2OfDataset],),  # noqa: E501
            'errors': ([CriteoApiErrorV2],),  # noqa: E501
            'warnings': ([CriteoApiWarningV2],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            data ([EntityV2OfDataset]): The response’s primary data. [optional]  # noqa: E501
            errors ([CriteoApiErrorV2]): Error list returned by the Criteo API  For successful requests it is empty. [optional]  # noqa: E501
            warnings ([CriteoApiWarningV2]): Warnings list returned by the Criteo API  In some situations the operations are successful but it may be useful to issue warnings to the API consumer.  For example the endpoint, entity or field is deprecated. Warnings are like compiler warnings, they indicate that problems may occur in the future.. [optional]  # noqa: E501
        """

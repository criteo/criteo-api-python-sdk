...
def lazy_import():
    ...
    globals()['PreviewError'] = PreviewError
    globals()['PreviewWarning'] = PreviewWarning


class PreviewFailResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, errors, warnings, *args, **kwargs):  # noqa: E501
        """PreviewFailResponse - a model defined in OpenAPI

        Args:
            errors ([PreviewError]): List of errors

...
def lazy_import():
    ...
    globals()['ReportEntityMessage'] = ReportEntityMessage


class ReportDataMessage(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ReportEntityMessage],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ReportDataMessage - a model defined in OpenAPI

        Args:
            data ([ReportEntityMessage]):

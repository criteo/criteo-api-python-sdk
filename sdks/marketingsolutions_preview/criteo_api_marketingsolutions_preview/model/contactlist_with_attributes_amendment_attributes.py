...
class ContactlistWithAttributesAmendmentAttributes(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'gum_caller_id': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, operation, identifier_type, identifiers, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            gum_caller_id ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): The Gum caller id of the advertiser patching identifiers of type Gum. [optional]  # noqa: E501
        """

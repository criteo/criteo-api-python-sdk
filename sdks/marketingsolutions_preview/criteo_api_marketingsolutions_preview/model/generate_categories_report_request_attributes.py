...
class GenerateCategoriesReportRequestAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, advertiser_ids, format, start_date, end_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            campaign_id (str): Report only on the specified Campaign id.. [optional]  # noqa: E501
            adset_id (str): Report only on the specified AdSet id.. [optional]  # noqa: E501
            domain (str): Report only on the specified domain.. [optional]  # noqa: E501
            category (str): Report only on the specified category.. [optional]  # noqa: E501

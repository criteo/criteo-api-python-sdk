...
class GenerateCategoriesReportRequestAttributes(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'should_display_domain_dimension': (bool, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, advertiser_ids, format, start_date, end_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            should_display_domain_dimension (bool, none_type): Specify if the domain dimension is displayed in the report.. [optional] if omitted the server will use the default value of True  # noqa: E501

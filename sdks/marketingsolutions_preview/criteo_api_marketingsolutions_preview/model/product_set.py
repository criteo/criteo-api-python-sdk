...
class ProductSet(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            number_of_products (int): The number of product matching the product set. [optional]  # noqa: E501
            creation_date (str): Optional: The creation date of the product set (UTC time in ISO8601 format). Example: \"02/25/2022 14:51:26\"  Can be null if the value doesn't exist.. [optional]  # noqa: E501
            rules ([ProductSetRule]): The rules identifying the product belonging to the set. [optional]  # noqa: E501

...
class ProductSetPreview(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, partner_id, rules, *args, **kwargs):  # noqa: E501
        """ProductSetPreview - a model defined in OpenAPI

        Args:
            partner_id (int): PartnerId
            rules ([Rules]): ProductSet rules
    ...
    @convert_js_args_to_python_args
    def __init__(self, partner_id, rules, *args, **kwargs):  # noqa: E501
        """ProductSetPreview - a model defined in OpenAPI

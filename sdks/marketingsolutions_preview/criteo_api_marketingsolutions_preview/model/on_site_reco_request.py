...
class OnSiteRecoRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, nb_requested_products, partner_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            user_id (str, none_type): Used to retrieve user events from Criteo trackers.. [optional]  # noqa: E501
            identity_type (str, none_type): Type of the user identifier (CtoBundle, Idfa, Gaid...)  Optional if its type is CtoBundle. [optional]  # noqa: E501

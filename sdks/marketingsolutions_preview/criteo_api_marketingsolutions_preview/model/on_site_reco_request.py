...
class OnSiteRecoRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'identity_type': (str, none_type,),  # noqa: E501
            'user_events': ([UserEvent], none_type,),  # noqa: E501
            'ad_set_id': (int, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, nb_requested_products, partner_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            user_id (str, none_type): Used to retrieve user events from Criteo trackers. Optional if UserEvents are passed.. [optional]  # noqa: E501
            identity_type (str, none_type): Type of the user identifier (cto_bundle, Idfa, Gaid...)  Optional if UserId is not set or if its type is cto_bundle. [optional]  # noqa: E501
            user_events ([UserEvent], none_type): Used to perform a recommendation without relying on events stored for a UserId. Optional if UserId is passed.. [optional]  # noqa: E501
            ad_set_id (int, none_type): Id of the AdSet. This field is optional and is resolved automatically for adsets previously configured.. [optional]  # noqa: E501
            ad_id (int, none_type): Id of the Ad. This field is optional, it allows to setup Reco controls at Ad level.. [optional]  # noqa: E501
        """

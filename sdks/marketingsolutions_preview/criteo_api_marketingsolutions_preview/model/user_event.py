...
class UserEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_external_id, type, date_time, *args, **kwargs):  # noqa: E501
        """UserEvent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_external_id, type, date_time, *args, **kwargs):  # noqa: E501
        """UserEvent - a model defined in OpenAPI

...
class AdvertiserCreationInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_name, website_url, country_iso_code, currency_iso_code, industry_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_name, website_url, country_iso_code, currency_iso_code, industry_id, *args, **kwargs):  # noqa: E501
        """AdvertiserCreationInput - a model defined in OpenAPI

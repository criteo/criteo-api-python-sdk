...
class TargetingErrorModel(ModelNormal):
    ...
    def _from_openapi_data(cls, code, instance, trace_id, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            detail (str): A human-readable detailed explanation specific to this occurrence of the problem.. [optional]  # noqa: E501
            source ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): A machine-readable structure to reference to the exact location(s) causing the error(s).. [optional]  # noqa: E501

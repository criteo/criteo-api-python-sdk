...
class GenerateAudiencePerformanceReportRequestAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, start_date, end_date, advertiser_id, dimension, metrics, *args, **kwargs):  # noqa: E501
        """GenerateAudiencePerformanceReportRequestAttributes - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            audience_ids ([str]): The list of Audiences ids. If empty, all the Audiences will be fetched. [optional]  # noqa: E501
            segments_ids ([str]): The list of Segments ids. If empty, all the segments will be fetched. [optional]  # noqa: E501
        """

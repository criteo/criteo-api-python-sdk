...
class AudienceSegmentCreateEntityV1(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, advertiser_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, advertiser_id, *args, **kwargs):  # noqa: E501
        """AudienceSegmentCreateEntityV1 - a model defined in OpenAPI

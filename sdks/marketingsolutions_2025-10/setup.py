...
```sh
pip install criteo-api-marketingsolutions-sdk==2025.10.0.251216
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2025.10.0.251216`)

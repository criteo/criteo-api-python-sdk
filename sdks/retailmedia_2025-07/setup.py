...
```sh
pip install criteo-api-retailmedia-sdk==2025.07.0.260323
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2025.07.0.260323`)

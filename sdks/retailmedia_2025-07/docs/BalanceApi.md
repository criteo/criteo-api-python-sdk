# criteo_api_retailmedia_v2025_07.BalanceApi

All URIs are relative to *https://api.criteo.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_funds_by_account_and_balance_id**](BalanceApi.md#add_funds_by_account_and_balance_id) | **POST** /2025-07/retail-media/accounts/{account-id}/balances/{balance-id}/add-funds | /2025-07/retail-media/accounts/{account-id}/balances/{balance-id}/add-funds
[**change_dates_by_account_and_balance_id**](BalanceApi.md#change_dates_by_account_and_balance_id) | **POST** /2025-07/retail-media/accounts/{account-id}/balances/{balance-id}/change-dates | /2025-07/retail-media/accounts/{account-id}/balances/{balance-id}/change-dates
[**create_balance_by_account_id**](BalanceApi.md#create_balance_by_account_id) | **POST** /2025-07/retail-media/accounts/{account-id}/balances | /2025-07/retail-media/accounts/{account-id}/balances
[**get_balance_by_account_and_balance_id**](BalanceApi.md#get_balance_by_account_and_balance_id) | **GET** /2025-07/retail-media/accounts/{account-id}/balances/{balance-id} | /2025-07/retail-media/accounts/{account-id}/balances/{balance-id}
[**get_balance_history**](BalanceApi.md#get_balance_history) | **GET** /2025-07/retail-media/balances/{balanceId}/history | /2025-07/retail-media/balances/{balanceId}/history
[**get_balances_by_account_id**](BalanceApi.md#get_balances_by_account_id) | **GET** /2025-07/retail-media/accounts/{account-id}/balances | /2025-07/retail-media/accounts/{account-id}/balances
[**get_campaigns_by_balance_id**](BalanceApi.md#get_campaigns_by_balance_id) | **GET** /2025-07/retail-media/balances/{balance-id}/campaigns | /2025-07/retail-media/balances/{balance-id}/campaigns
[**modify_balance_by_account_and_balance_id**](BalanceApi.md#modify_balance_by_account_and_balance_id) | **PATCH** /2025-07/retail-media/accounts/{account-id}/balances/{balance-id} | /2025-07/retail-media/accounts/{account-id}/balances/{balance-id}

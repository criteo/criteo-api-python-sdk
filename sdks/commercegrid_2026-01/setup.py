...
```sh
pip install criteo-api-commercegrid-sdk==2026.01.0.260730
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-commercegrid-sdk==2026.01.0.260730`)

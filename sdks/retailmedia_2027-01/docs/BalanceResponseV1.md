...
**end_date** | **str, none_type** | End date of the balance in the format YYYY-MM-DD. | 
**memo** | **str, none_type** | Memo. | 
**name** | **str** | Name of the balance. | 
**private_market_billing_type** | **str** | Billing type for Private Market of the balance. | 
**remaining** | **float, none_type** | Amount of remaining funds of the balance. | 
**retailer_po_number** | **str, none_type** | Purchase Order number. | 
**spend_type** | **str** | Spend Type of the balance. | 
**spent** | **float, none_type** | Amount of spent funds of the balance. | 
**start_date** | **str** | Start date of the balance in the format YYYY-MM-DD. | 
**status** | **str** | Status of the balance. | 

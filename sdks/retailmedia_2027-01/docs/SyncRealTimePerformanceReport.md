...
**dimensions** | **[str]** | List of dimensions to report on (real-time: at least one required). Only the supported dimension values are valid. | [optional] 
...
**metrics** | **[str]** | List of metrics to report on (real-time: at least one required). Only the supported metric values are valid. | [optional] 

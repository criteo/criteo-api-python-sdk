...
class CampaignV202301(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_id, promoted_brand_ids, budget_spent, budget_remaining, created_at, updated_at, name, is_auto_daily_pacing, start_date, end_date, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_id, promoted_brand_ids, budget_spent, budget_remaining, created_at, updated_at, name, is_auto_daily_pacing, start_date, end_date, *args, **kwargs):  # noqa: E501
        """CampaignV202301 - a model defined in OpenAPI

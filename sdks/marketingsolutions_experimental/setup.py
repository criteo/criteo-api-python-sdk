...
```sh
pip install criteo-api-marketingsolutions-sdk==0.0.260817
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==0.0.260817`)

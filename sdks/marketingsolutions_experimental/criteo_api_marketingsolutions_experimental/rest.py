...
from criteo_api_marketingsolutions_experimental.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError

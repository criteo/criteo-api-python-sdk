...
class GenerateCreativesReportRequestAttributes(ModelNormal):
    ...
    allowed_values = {
        ...
        ('ad_formats',): {
            ...
            'VAST/VPAID_TAGS': "VAST/VPAID Tags",
    ...
    def _from_openapi_data(cls, advertiser_ids, dimensions, end_date, metrics, start_date, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            ad_formats ([str], none_type): Optional list of ad formats to filter on. If empty, all ad formats will be included.. [optional]  # noqa: E501
            ad_ids ([str], none_type): Optional list of ad IDs to filter on. If empty, all ads will be included.. [optional]  # noqa: E501
            ad_names ([str], none_type): Optional list of ad names to filter on. If empty, all ads will be included.. [optional]  # noqa: E501
            ad_set_ids ([str], none_type): Optional list of ad set IDs to filter on. If empty, all ad sets will be included.. [optional]  # noqa: E501
            ...
            campaign_ids ([str], none_type): Optional list of marketing campaign IDs to filter on. If empty, all campaigns will be included.. [optional]  # noqa: E501
            coupon_ids ([str], none_type): Optional list of coupon IDs to filter on. If empty, all coupons will be included.. [optional]  # noqa: E501
            coupon_names ([str], none_type): Optional list of coupon names to filter on. If empty, all coupons will be included.. [optional]  # noqa: E501
            display_sizes ([str], none_type): Optional list of display sizes to filter on. If empty, all display sizes will be included. <br /><br /> Most common values: 'Native', 'Skyscraper', 'HalfPage', 'MediumBanner', 'LargeBanner', 'LeaderBoard', 'WideLeaderBoard', 'Other placements', 'Others'.. [optional]  # noqa: E501

...
class GenerateAllProductsReportRequestAttributes(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'file_format': (str, none_type,),  # noqa: E501
            'metrics': ([str], none_type,),  # noqa: E501
            'seller_ids': ([str], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'seller_ids': 'sellerIds',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, advertiser_ids, start_date, *args, **kwargs):  # noqa: E501
        """GenerateAllProductsReportRequestAttributes - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ad_set_ids ([str], none_type): The list of ad set ids.. [optional]  # noqa: E501
            ...
            end_date (datetime, none_type): End date of the report. ISO 8601 date-time (UTC). Defaults to Now if not provided.. [optional]  # noqa: E501
            file_format (str, none_type): The output file format. Supported: csv, json.. [optional] if omitted the server will use the default value of "csv"  # noqa: E501
            metrics ([str], none_type): The list of metrics to report.. [optional]  # noqa: E501
            seller_ids ([str], none_type): The list of seller ids.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, advertiser_ids, start_date, *args, **kwargs):  # noqa: E501
        """GenerateAllProductsReportRequestAttributes - a model defined in OpenAPI

...
class ReadAdSetScheduledBudgetV26Q1(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ReadAdSetScheduledBudgetV26Q1 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            budget_amount (float, none_type): Maximum budget amount in the advertiser's currency per renewal period. Non-null when capped. null when uncapped.. [optional]  # noqa: E501
            ...
            id (str, none_type): Identifier of the scheduled budget.. [optional]  # noqa: E501
            pacing_behavior (str, none_type): Controls how a standard capped budget is paced.  - \"targetFullBudget\": spend toward the full budget amount within the renewal period.  - \"targetAverageDailyBudget\": spend toward an average daily amount. Only supported for capped, standard, monthly budgets.  - \"undefined\": no explicit pacing behavior. Use for uncapped or accelerated budgets, or omit pacingBehavior.. [optional]  # noqa: E501
            start_date (date, none_type): Advertiser-local calendar date when the scheduled budget becomes active.. [optional]  # noqa: E501
        """

...
class PatchCampaignScheduledSpendLimitCreation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, spend_limit_type, start_date, *args, **kwargs):  # noqa: E501
        """PatchCampaignScheduledSpendLimitCreation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, spend_limit_type, start_date, *args, **kwargs):  # noqa: E501
        """PatchCampaignScheduledSpendLimitCreation - a model defined in OpenAPI

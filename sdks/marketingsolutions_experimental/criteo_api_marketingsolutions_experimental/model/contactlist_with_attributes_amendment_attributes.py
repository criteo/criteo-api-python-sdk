...
def lazy_import():
    ...
    globals()['UserDef'] = UserDef


class ContactlistWithAttributesAmendmentAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, identifiers, identifier_type, operation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            gum_caller_id ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The Gum caller id of the advertiser patching identifiers of type Gum. [optional]  # noqa: E501
        """

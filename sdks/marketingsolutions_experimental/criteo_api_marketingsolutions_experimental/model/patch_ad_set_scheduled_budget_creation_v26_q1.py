...
class PatchAdSetScheduledBudgetCreationV26Q1(ModelNormal):
    ...
    def _from_openapi_data(cls, start_date, *args, **kwargs):  # noqa: E501
        """PatchAdSetScheduledBudgetCreationV26Q1 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            budget_amount (float, none_type): Maximum budget amount in the advertiser's currency per renewal period.  Required when budgetStrategy is \"capped\"; must be omitted when budgetStrategy is \"uncapped\".. [optional]  # noqa: E501

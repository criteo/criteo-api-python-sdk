...
class PatchCampaignScheduledSpendLimitUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, spend_limit_type, start_date, *args, **kwargs):  # noqa: E501
        """PatchCampaignScheduledSpendLimitUpdate - a model defined in OpenAPI
        ...
        self.id = id
        self.spend_limit_type = spend_limit_type
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, spend_limit_type, start_date, *args, **kwargs):  # noqa: E501
        """PatchCampaignScheduledSpendLimitUpdate - a model defined in OpenAPI

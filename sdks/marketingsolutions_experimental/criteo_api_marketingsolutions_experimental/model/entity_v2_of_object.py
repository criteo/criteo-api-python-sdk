...
class EntityV2OfObject(ModelNormal):
    ...
    def _from_openapi_data(cls, id, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            attributes ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Generic Criteo API successful data model  While others may be computed e.g. lastChangedDate.  Computed attributes are only part of the read model and not part of the write model.. [optional]  # noqa: E501
            ...
            relationships ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Relationships with this entity. [optional]  # noqa: E501
        """

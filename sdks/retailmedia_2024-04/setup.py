...
```sh
pip install criteo-api-retailmedia-sdk==2024.04.0.250703
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2024.04.0.250703`)

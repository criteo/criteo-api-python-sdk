...
```sh
pip install criteo-api-retailmedia-sdk==2024.07.0.250716
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2024.07.0.250716`)

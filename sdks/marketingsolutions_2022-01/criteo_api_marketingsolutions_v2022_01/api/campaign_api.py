    ...
    def __init__(self, api_client=None):
        ...
        self.get_ad_set = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/ad-sets/{adSetId}',
        ...
        self.get_campaign = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/campaigns/{campaign-id}',
        ...
        self.patch_ad_sets = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/ad-sets',
        ...
        self.patch_campaigns = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/campaigns',
        ...
        self.search_ad_sets = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/ad-sets/search',
        ...
        self.search_campaigns = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/campaigns/search',
        ...
        self.start_ad_sets = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/ad-sets/start',
        ...
        self.stop_ad_sets = _Endpoint(
            settings={
                ...
                'endpoint_path': '/2022-01/marketing-solutions/ad-sets/stop',

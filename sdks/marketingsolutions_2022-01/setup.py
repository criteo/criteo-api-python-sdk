...
```sh
pip install criteo-api-marketingsolutions-sdk==2022.01.0.221103
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2022.01.0.221103`)

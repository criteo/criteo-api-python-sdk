...
```sh
pip install criteo-api-marketingsolutions-sdk==2025.01.0.250619
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2025.01.0.250619`)

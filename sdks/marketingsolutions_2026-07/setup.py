...
```sh
pip install criteo-api-marketingsolutions-sdk==2026.07.0.260817
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2026.07.0.260817`)

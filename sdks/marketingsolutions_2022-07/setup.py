...
```sh
pip install criteo-api-marketingsolutions-sdk==2022.07.0.220725
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-marketingsolutions-sdk==2022.07.0.220725`)

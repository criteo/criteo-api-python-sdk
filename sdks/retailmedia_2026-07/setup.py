...
```sh
pip install criteo-api-retailmedia-sdk==2026.07.0.260824
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2026.07.0.260824`)

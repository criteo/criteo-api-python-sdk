...
```sh
pip install criteo-api-retailmedia-sdk==2022.04.0.220725
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2022.04.0.220725`)

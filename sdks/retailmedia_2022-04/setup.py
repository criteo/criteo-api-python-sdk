...
```sh
pip install criteo-api-retailmedia-sdk==2022.04.0.221103
```
(you may need to run `pip` with root permission: `sudo pip install criteo-api-retailmedia-sdk==2022.04.0.221103`)
